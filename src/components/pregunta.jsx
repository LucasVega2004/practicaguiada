...
const Pregunta = ({ pregunta, borrarPregunta }) => {
    // console.log(preguntas + "asdasdasd")
    ...
    return (
        <div className="card" style={{ width: "18rem" }}>
            <button type="button" className="align-baseline btn-close" aria-label="Close" onClick={() => borrarPregunta(id)}></button>
            <div className="card-body">
                ...
                <div className="btn-group-vertical" role="group" aria-label="Vertical radio toggle button group">
                    <input type="radio" className="btn-check" name="btn-respuesta" id={`${id}vbtn-radio1`} autoComplete="off" />
                    <label className="btn btn-outline-danger" htmlFor={`${id}vbtn-radio1`}>{respuesta1}</label>
                    <input type="radio" className="btn-check" name="btn-respuesta" id={`${id}vbtn-radio2`} autoComplete="off" />
                    <label className="btn btn-outline-danger" htmlFor={`${id}vbtn-radio2`}>{respuesta2}</label>
                    <input type="radio" className="btn-check" name="btn-respuesta" id={`${id}vbtn-radio3`} autoComplete="off" />
                    <label className="btn btn-outline-danger" htmlFor={`${id}vbtn-radio3`}>{respuesta3}</label>
                    <input type="radio" className="btn-check" name="btn-respuesta" id={`${id}vbtn-radio4`} autoComplete="off" />
